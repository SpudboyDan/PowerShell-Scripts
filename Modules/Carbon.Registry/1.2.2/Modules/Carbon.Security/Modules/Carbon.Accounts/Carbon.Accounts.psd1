...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/Carbon.Accounts'
            ...
            ReleaseNotes = 'https://github.com/webmd-health-services/Carbon.Accounts/blob/main/CHANGELOG.md'
