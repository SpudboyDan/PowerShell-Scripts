...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/Carbon.Registry'
            ...
            ReleaseNotes = 'https://github.com/webmd-health-services/Carbon.Registry/blob/main/CHANGELOG.md'
