...
[string]$matchExpression = '\"cinemaId\"\:\"0701\"\,\"sessionId\"\:\"[0-9]+\"\,\"presentationSlug\"\:\"special-event-secret-screening-[0-9]+\"\,\"legacySlug\"\:\"secret-screening-[0-9]+\"\,\"status\"\:\"ONSALE\"';
...
{
	{$_ -notmatch $matchExpression} {stop;}
	{$_ -imatch $matchExpression} {Send-ScreeningAlert;}
}
